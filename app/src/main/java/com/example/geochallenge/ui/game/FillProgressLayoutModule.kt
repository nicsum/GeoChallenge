    ...
    fun setProgress(p: Int) {
        if (p in 0..maxProgress) {
            ...
            animator.addUpdateListener { anm ->
                ...
                if (currentProgress==50){setProgressBackgroundColor(R.color.colorAccentYellow)}
                if (currentProgress==85){setProgressBackgroundColor(R.color.colorMaterialRed500)}
